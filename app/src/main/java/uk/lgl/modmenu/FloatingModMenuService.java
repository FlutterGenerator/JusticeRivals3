...
public class FloatingModMenuService extends Service {
  ...
  int MENU_BG_COLOR = Color.parseColor("#50A7FF00"); // #AARRGGBB
  int MENU_FEATURE_BG_COLOR = Color.parseColor("#50A7FF00"); // #AARRGGBB
  int MENU_WIDTH = 290;
  int MENU_HEIGHT = 210;
  ...
  private View Spinner(final int featNum, final String featName, final String list) {
    ...
    // Define the main LinearLayout
    LinearLayout mainLayout = new LinearLayout(this);
    LinearLayout.LayoutParams mainLayoutParams =
        new LinearLayout.LayoutParams(
            LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
    mainLayoutParams.setMargins(7, 7, 7, 7);
    mainLayout.setOrientation(LinearLayout.HORIZONTAL);
    mainLayout.setBackgroundColor(Color.TRANSPARENT);
    mainLayout.setLayoutParams(mainLayoutParams);
    RelativeLayout relativeLayout = new RelativeLayout(this);
    int height = (int) (dp(17) * getResources().getDisplayMetrics().density);
    LinearLayout.LayoutParams relativeLayoutParams = new LinearLayout.LayoutParams(0, height, 1);
    relativeLayout.setLayoutParams(relativeLayoutParams);
    GradientDrawable gradientDrawable = new GradientDrawable();
    gradientDrawable.setColor(Color.WHITE); // Set the background color to white
    ...
    selectedItemView.setTextSize(20);
    ...
    ArrayAdapter<String> aa =
        new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, lists);
    ...
    spinner.setOnItemSelectedListener(
        new AdapterView.OnItemSelectedListener() {
          ...
          public void onItemSelected(
              AdapterView<?> parentView, View selectedItemViewSpinner, int position, long id) {
    ...
    byte[] leftBg = Base64.decode(lLeft(), Base64.DEFAULT);
    Bitmap leftBitmap = BitmapFactory.decodeByteArray(leftBg, 0, leftBg.length);
    BitmapDrawable leftBackground = new BitmapDrawable(getResources(), leftBitmap);
    Button leftButton = new Button(this);
    leftButton.setLayoutParams(new LinearLayout.LayoutParams(buttonWidth, buttonHeight));
    ...
    byte[] rightBg = Base64.decode(right(), Base64.DEFAULT);
    Bitmap rightBitmap = BitmapFactory.decodeByteArray(rightBg, 0, rightBg.length);
    BitmapDrawable rightBackground = new BitmapDrawable(getResources(), rightBitmap);
    Button rightButton = new Button(this);
    rightButton.setLayoutParams(new LinearLayout.LayoutParams(buttonWidth, buttonHeight));
